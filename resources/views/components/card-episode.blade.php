<div class="card-episode col-xl-2 col-lg-3 col-md-4 col-sm-12 px-1 mb-2" data-show="{{$episode->show->uuid}}" data-episode="{{$episode->uuid}}" data-airdate="{{Carbon\Carbon::parse($episode->airing_at)->format('Y-m-d H:i:s')}}" data-filter="{{$episode->show->name}}">
